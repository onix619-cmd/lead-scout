...
<section id="order-grab" class="py-14" style="background:var(--accent);">
  <div class="max-w-md mx-auto px-6 text-center">
    ...
    <div class="flex flex-col gap-3">
      <textarea id="grab-order-text" rows="3" placeholder="What would you like to order? (e.g. 2x Burgers, 1x Fries...)" class="w-full rounded-md px-4 py-3 text-sm ${R ? "bg-black/30 border border-white/15 text-white placeholder-white/40" : "bg-white border border-slate-300 text-slate-900"} resize-y shadow-inner"></textarea>
